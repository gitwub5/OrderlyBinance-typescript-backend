...
export interface ConfigurationOptionsClient {
  contractId: string;
  networkId?: keyof typeof NearNetworkId | NearNetworkId.mainnet; // "testnet" or "mainnet"
...
export const environment = (networkId: keyof typeof NearNetworkId) => {
    if (networkId === 'testnet') {
      ...
      return {
        ...
        config: {
          apiUrl: 'https://api-evm.orderly.org',
          privateWsUrl: 'wss://ws-private-evm.orderly.org',
          publicWsUrl: 'wss://ws.orderly-evm.org',
          publicWebsocketKey: 'OqdphuyCtYWxwzhxyLLjOWNdFP7sQt8RPWzmb5xY',
        },
      }
    }
